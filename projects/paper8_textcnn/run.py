from projects.paper8_textcnn.model import CNN
import utils
...
def train(data, params):
    if params["MODEL"] != "rand":
        ...
        word_vectors = KeyedVectors.load_word2vec_format("https://s3.amazonaws.com/dl4j-distribution/GoogleNews-vectors-negative300.bin.gz",
                                                         binary=True)
        ...
        print("one for UNK and one for zero padding")
