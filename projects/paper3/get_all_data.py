...
class Dataset():
    ...
    def get_all_datas(self):
        ...
        '''
        train_neg_datas = self.get_data(path="./aclImdb/train/neg/")
        train_pos_datas = self.get_data(path="./aclImdb/train/pos/")
        train_unsup = self.get_data(path="./aclImdb/train/unsup/")
        test_neg_datas = self.get_data(path="./aclImdb/test/neg/")
        test_pos_datas = self.get_data(path="./aclImdb/test/pos/")
        ...
        print("the length of train_datas and train_labels:", len(train_datas), len(train_labels))
        print("the lenght of train_unsup:", len(train_unsup))
        print("the lentgh of test_datas and test_labels:", len(test_datas), len(test_labels))
    ...
    def convert_data_to_new_data(self, datas):
        ...
        print("the shape of new_word_datas:", new_word_datas.shape)
        print("the shape of new_papr_datas:", new_papr_datas.shape)
        print("the shape of new_labels:", new_labels.shape)
